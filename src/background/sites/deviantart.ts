...
type DeviantartOptionsValues = SiteOptions<typeof deviantart_form>;

type DeviantartFileMeta = Pick<DeviantartFile, 'fileName' | 'ext'>;
type DeviantartFileData = FileData<DeviantartFileMeta>;
type DeviantartSubmissionMeta = Omit<DeviantartFile, keyof DeviantartFileMeta>;
type DeviantartSubmissionData = SubmissionData<DeviantartSubmissionMeta>;

type StashFileMeta = Pick<StashFile, 'fileName' | 'ext'>;
type StashFileData = FileData<StashFileMeta>;
type StashSubmissionMeta = Omit<StashFile, keyof StashFileMeta>;
type StashSubmissionData = { meta: StashSubmissionMeta };
